...
.method public static setListeners(Landroid/widget/DatePicker;IIILandroid/widget/DatePicker$OnDateChangedListener;Landroid/databinding/InverseBindingListener;Landroid/databinding/InverseBindingListener;Landroid/databinding/InverseBindingListener;)V
    ...
    .param p5, "yearChanged"    # Landroid/databinding/InverseBindingListener;
    .param p6, "monthChanged"    # Landroid/databinding/InverseBindingListener;
    .param p7, "dayChanged"    # Landroid/databinding/InverseBindingListener;
    ...
    invoke-static {p0, v1}, Landroid/databinding/adapters/ListenerUtil;->getListener(Landroid/view/View;I)Ljava/lang/Object;
    ...
    .line 48
    .local v0, "oldListener":Landroid/databinding/adapters/DatePickerBindingAdapter$DateChangedListener;
    if-nez v0, :cond_3

    .line 49
    new-instance v0, Landroid/databinding/adapters/DatePickerBindingAdapter$DateChangedListener;

    .end local v0    # "oldListener":Landroid/databinding/adapters/DatePickerBindingAdapter$DateChangedListener;
    const/4 v1, 0x0
    ...
    .line 50
    .restart local v0    # "oldListener":Landroid/databinding/adapters/DatePickerBindingAdapter$DateChangedListener;
    sget v1, Lcom/android/databinding/library/baseAdapters/R$id;->onDateChanged:I
